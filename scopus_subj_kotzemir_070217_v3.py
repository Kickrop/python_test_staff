...
subjarea ="ENER"
countryname = "SouthAfricaandworld"
...
def gettothepageandsavetofile():
    ...
    #entertext = u"""pubyear > 2010 and pubyear < 2016 and (DOCTYPE (ar) or DOCTYPE (cp) or DOCTYPE (re)) and affilcountry("Russian Federation" and "South Africa")""" + subjarea
...
#    driver.execute_script("arguments[0].setAttribute('value', arguments[1])", inputField, entertext)
    ...
    with open("kozemir070217/" + "JSON_"+ filename + "_" + str(i) + ".txt", "w") as myfile:
    #print str(afil)
