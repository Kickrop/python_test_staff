...
countryname = "india-total"
subjarea = "subjarea(ENER)"

dicts_from_file = []
with open('org_scopus/org_india.txt','r') as inf:
    for line in inf:
        dicts_from_file.append(eval('line'))

s = 0
num_lines = sum(1 for line in open('org_scopus/org_india.txt'))
do = num_lines#160
...
def gettothepageandsavetofile():
    ...
    with open("kozemir070217/" + "ORG_" + filename + ".txt", "a") as myfile:
